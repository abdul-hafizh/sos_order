...
const searchBarangOptions = async () => {
    const res = await axios.get(route('master-produk.barang-options'), {
        params: {
            search: barangKeyword.value,
            current: editingProduk.value?.kode_barang || null,
        },
    });
...
const submit = () => {
    if (editingProduk.value) {
        router.post(
            route('master-produk.update', editingProduk.value.id_produk),
        ...
        <div class="py-7 w-full mx-auto px-6 bg-white border border-gray-200 rounded-2xl shadow-md">
            <div class="mb-5">
                <Item variant="outline" class="py-3 gap-3 flex-col md:flex-row items-center md:items-center text-center md:text-left">
                    ...
                    <ItemContent class="w-full">
                        ...
                        <ItemDescription class="text-sm">Kelola produk beserta atribut dan foto, dihubungkan ke kode barang.</ItemDescription>
                    </ItemContent>
            ...
            <div class="hidden md:block rounded-md border bg-white overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <tr v-for="item in produk.data" :key="item.id_produk" class="border-t align-top">
                            <td class="p-3">
                            ...
                            <td class="p-3">
                                ...
                                <div class="text-xs text-gray-500 mt-1 line-clamp-2">{{ item.deskripsi || '-' }}</div>
                            </td>
                            <td class="p-3">
            ...
            <div class="md:hidden space-y-3">
                <div v-for="item in produk.data" :key="item.id_produk" class="border rounded-lg p-3 bg-white shadow-sm">
                    <div class="flex gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="font-medium truncate">{{ item.nama_produk }}</div>
                ...
                <div v-if="produk.data.length === 0" class="p-8 text-center text-gray-400 border rounded-lg bg-white">
                    Belum ada produk.
                </div>
            </div>
                ...
                <div class="bg-white p-6 rounded-lg w-full max-w-2xl shadow-xl max-h-[90vh] overflow-y-auto">
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Hanya barang yang belum terhubung ke produk lain yang muncul di daftar.</p>
